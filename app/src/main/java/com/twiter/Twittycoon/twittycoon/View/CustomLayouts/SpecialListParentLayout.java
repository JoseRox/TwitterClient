...
public class SpecialListParentLayout extends RelativeLayout /*implements ViewTreeObserver.OnGlobalLayoutListener*/ {

    private static final int SPACER_VIEW_ID = 7363;
    private ListView mResultList;
    private View mHeaderSpace;

    public SpecialListParentLayout(Context context) {
        super(context);
    }

    public SpecialListParentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SpecialListParentLayout(Context context, AttributeSet attrs, int defStyle) {
